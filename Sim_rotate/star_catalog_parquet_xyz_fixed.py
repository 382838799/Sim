...
if __name__ == '__main__':
    ...
    for i in range(1, 2):
        ...
        csv_file = f'/mnt/d/XT/AAA_Simulation/JG02/JG02Data/geocam/10/{csv}'  # 保持CSV格式的输入参数文件
        excel_output_dir = f'/mnt/d/XT/AAA_Simulation/JG02/10/{chapter}/StarProperties/'  # Excel文件输出目录
