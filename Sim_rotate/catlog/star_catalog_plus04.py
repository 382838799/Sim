...
if __name__ == '__main__':
    # 设置参数（恢复原来的参数设置方式）
    csv_file = '/mnt/d/Simulation/5.00000.csv'  # 保持CSV格式的输入参数文件
    input_dir = '/mnt/d/gaia/data_parquet/'  # 768个星表Parquet文件所在的文件夹路径
    fits_output_dir = '/mnt/d/Simulation/output/chapter24/xydata_par'  # FITS文件输出目录
    excel_output_dir = '/mnt/d/Simulation/output/chapter24/xydata_par'  # Excel文件输出目录
