...
def filter_data_by_fov_and_mag(path, ra_cam, dec_cam, radius_deg, min_mag, max_mag, nside, output_dir, title=None):
    ...
    for pixel_file in relevant_files:
        ...
        try:
            ...
            for chunk in pd.read_csv(pixel_file_path, compression='gzip', usecols=cols, chunksize=100000):
                # 星等筛选
...
if __name__ == '__main__':
    ...
    input_dir = '/mnt/d/gaia/gaia_csv/'  # 768个星表文件所在的文件夹路径
    fits_output_dir = '/mnt/d/Simulation/output/chapter24/xydata'  # FITS文件输出目录
    excel_output_dir = '/mnt/d/Simulation/output/chapter24/xydata'  # Excel文件输出目录
